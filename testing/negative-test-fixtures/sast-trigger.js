...
// ERROR) so the negative-test workflow can prove SAST actually detects
// and blocks on real findings. This code is never executed, imported, or
// built into any real service — it exists only for this controlled test.
