...
Turn a real event into a structured claim carrying entity, timestamp, source, evidence ID, confidence.

## Done when

A claim comes out of a real event with its evidence attached.
...
Do not invent facts. Everything traces to stored evidence. Insufficient evidence beats fabricated certainty.
