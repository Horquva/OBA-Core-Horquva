...
const tests = [
    ...
    'recommendationEngine.unit.test.js', // pure; asserts M04's 7 ruleclasses (W-K D-62)
    ...
    'agentLoop.unit.test.js', // stubbed; six loop scenarios includingcap, retry, abort and timeout (W-L 11.5)
