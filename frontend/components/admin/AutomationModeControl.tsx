      ...
      <div className="flex items-center gap-3 mb-5">
        ...
        <div>
          ...
          <p className="text-xs text-slate-400">
            ...
            <span className="font-mono text-slate-500">/api/orchestration/mode</span>
          </p>
        </div>
      </div>
      ...
      <div className="card px-6 py-5 border border-[#1f1f29]">
        ...
        {state.status === 'loading' && (
          <div className="flex items-center gap-4">
            <div className="w-24 h-7 rounded bg-[#1f1f29] animate-pulse-soft" />
            <div className="w-48 h-4 rounded bg-[#1f1f29] animate-pulse-soft" />
          </div>
        )}
          ...
          <div className="flex items-start gap-3">
            ...
            <div>
              <p className="text-sm text-slate-300 mb-1">
                ...
                <span className="font-mono text-slate-400">/api/orchestration/mode</span>
              </p>
              <p className="text-xs text-slate-500">{state.errorMessage}</p>
              <div className="mt-3 px-4 py-2.5 rounded-lg bg-[#111116] border border-[#1f1f29]">
                <p className="text-xs text-slate-400">
