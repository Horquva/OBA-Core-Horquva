    ...
    case 'NOT_MOUNTED':
      return (
        <div className="flex items-center gap-1.5">
          ...
          <span className="text-xs text-slate-500 font-semibold">NOT MOUNTED</span>
        </div>
      );
    case 'CHECKING':
      return (
  ...
  return (
    <tr key={index}>
      <td className="px-5 py-4">
        <div className="h-4 w-24 rounded bg-[#1f1f29] animate-pulse-soft" />
      </td>
      <td className="px-5 py-4">
        <div className="h-4 w-36 rounded bg-[#1f1f29] animate-pulse-soft" />
      </td>
      <td className="px-5 py-4">
        <div className="h-4 w-20 rounded bg-[#1f1f29] animate-pulse-soft" />
      </td>
      <td className="px-5 py-4">
        <div className="h-4 w-16 rounded bg-[#1f1f29] animate-pulse-soft" />
      </td>
      <td className="px-5 py-4">
        <div className="h-4 w-20 rounded bg-[#1f1f29] animate-pulse-soft" />
      </td>
      <td className="px-5 py-4">
        <div className="h-4 w-12 rounded bg-[#1f1f29] animate-pulse-soft ml-auto" />
      </td>
    </tr>
  );
}
  ...
  if (trackedResults.length === 0) {
    return (
      <div className="card px-6 py-10 flex flex-col items-center justify-center text-center animate-fade-up delay-400">
        ...
        <h3 className="text-white font-semibold mb-1">No Endpoints to Track</h3>
        <p className="text-sm text-slate-400">No mounted endpoints found in the route registry.</p>
      </div>
    );
  }
