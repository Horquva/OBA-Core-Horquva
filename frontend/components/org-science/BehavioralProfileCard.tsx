  ...
  return (
    <div className="card px-6 py-8 border border-[#1f1f29] flex flex-col items-center justify-center text-center h-full min-h-[280px]">
      ...
      <h3 className="text-white font-semibold mb-1">
        BehavioralProfile not yet connected
      </h3>
      <p className="text-sm text-slate-400 max-w-sm mb-4">
        Pending backend wiring (M44). Aggregate behavioral tendencies and norms is currently offline.
      </p>
      <div className="px-4 py-2.5 rounded-lg bg-[#111116] border border-[#1f1f29] w-full max-w-xs">
        <p className="text-xs text-slate-500">
          Ready to receive data once the M44 module is mounted on the backend.
        </p>
      </div>
    </div>
  );
