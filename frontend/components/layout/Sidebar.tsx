      ...
      >
        ...
        <div
          style={{
            ...
            filter:
              theme === "light"
                ? "drop-shadow(0 0 6px rgba(37, 99, 235, 0.2))"
                : "drop-shadow(0 0 8px rgba(129, 140, 248, 0.4))",
        ...
        >
          <svg width="34" height="34" viewBox="0 0 36 36" fill="none" xmlns="http://www.w3.org/2000/svg">
            {/* Outer Hexagon */}
            <path
              d="M18 2L31.856 10V26L18 34L4.144 26V10L18 2Z"
              fill={theme === "light" ? "url(#hex-grad-light)" : "url(#hex-grad)"}
              stroke={theme === "light" ? "url(#hex-stroke-light)" : "url(#hex-stroke)"}
              strokeWidth="1.5"
            ...
            <path
              d="M13 13V23"
              stroke={theme === "light" ? "var(--accent)" : "white"}
              strokeWidth="2.5"
              strokeLinecap="round"
              strokeLinejoin="round"
            />
            ...
            <path
              d="M13 18H23"
              stroke={theme === "light" ? "var(--accent)" : "url(#line-grad)"}
              strokeWidth="2.5"
              strokeLinecap="round"
              strokeLinejoin="round"
            />
        ...
        <div>
          ...
          <p
            style={{
              ...
              lineHeight: 1,
              borderBottom:
                theme === "light" ? "1px solid rgba(37, 99, 235, 0.2)" : "1px solid rgba(99, 102, 241, 0.15)",
              boxShadow:
                theme === "light"
        ...
        <div style={{ display: "flex", alignItems: "center", gap: "10px", minWidth: 0 }}>
          <div
            style={{
              ...
              borderRadius: "7px",
              background:
                theme === "light" ? "var(--bg-elevated)" : "linear-gradient(135deg, #1c1c28, #252535)",
