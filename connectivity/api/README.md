...
Evidence IDs, provenance, confidence and classification survive the API trip.
...
Do not reshape, default, classify, score, filter, rank or enrich. Domain logic stays with the capability owner.
