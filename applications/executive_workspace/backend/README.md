# applications/executive_workspace/backend
...
Service skeleton, database connectivity, API path structure with Affan.

## Done when

Services reach the databases from dev.
...
Nothing is filtered here for security. Authorization happens at retrieval.
