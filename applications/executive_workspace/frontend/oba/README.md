# applications/executive_workspace/frontend/oba
...
Frontend state vocabulary in code: idle, listening, processing, considering, responding, interrupted, error, reconnecting.

## Done when

The vocabulary exists as code and the shell can drive it.
