...
echo.
echo ============================================
echo  Starting all 6 services + gateway...
echo ============================================
...
echo Waiting 6 seconds for services to boot before starting the gateway...
timeout /t 6 /nobreak > nul

start "7-gateway" cmd /k "node gateway.js"
...
echo.
echo ============================================
echo  All 7 windows launched. Dashboard opening at:
